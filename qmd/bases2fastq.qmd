...
4.  Create your RunManifest.csv:
    ...
    o Information for preparing the RunManifest file can be found [here](https://docs.elembio.io/docs/run-manifest/).
...
5.  Move to your working folder:
    ...
    o In case there are [only samples from your lab]{.underline} run:

    ``` bash
    cd /mnt/new_home/stamatopoulos_research/
    ```

    o In case there are [samples from multiple labs]{.underline} run:
